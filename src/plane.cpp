...
const float DEFAULT_IDLE_THRUST = 37500 * multiplier; //365 units/s aprox
...
const float DEFAULT_RETURN_SPEED_HIGH = 4000 * multiplier;
const float DEFAULT_RETURN_SPEED_LOW = 2500 * multiplier;

const float DEFAULT_MAX_THRUST = 175000 * multiplier; //1700 units/s aprox
